...
function renderTable(data, tbodyId) {
    ...
    if (data.length === 0) {
        tbody.innerHTML = `<tr><td colspan="8" style="text-align:center; color:var(--A021A);">《公佈欄》正在查詢中．．．</td></tr>`;
        return;
    }
...
function filterData() {
    ...
    if (!isSearching) {
        // 【尚未搜尋狀態】
        profStatus.innerText = "《公佈欄》正在查詢中．．．";
        ...
        // 【搜尋/篩選進行中狀態】
        profStatus.innerText = "僅供參考";
        profStatus.style.color = "#76A5AF"; // 叫的時候變色！
