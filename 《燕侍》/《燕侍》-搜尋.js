...
function renderTable(data, tbodyId) {
    ...
    if (data.length === 0) {
        tbody.innerHTML = `<tr><td colspan="8" style="text-align:center; color:var(--A021A);">《燕侍》身為一個稱職的創作者，拖延是理所當然的！．．．</td></tr>`;
        return;
    }
...
function filterData() {
    ...
    if (!isSearching) {
        // 【尚未搜尋狀態】
        profStatus.innerText = "《燕侍》身為一個稱職的創作者，拖延是理所當然的！．．．";
